...
describe('Cart', () => {
  ...
  describe('getTotal()', () => {
    it('should return 0 when getTotal() is executed is a newly created instance', () => {
    ...
    it('should ensured no more than on product exists at a  time', () => {
      cart.add({
        product,
        quantity: 2,
      });
    ...
    it('should update totla when a product gets included and then removed', () => {
      cart.add({
        product,
        quantity: 2,
      });
  ...
  describe('special conditions', () => {
    ...
    it('should NOT apply quantity discount for odd quantities when condition is not met', () => {
      const condition = { quantity: 2 };
